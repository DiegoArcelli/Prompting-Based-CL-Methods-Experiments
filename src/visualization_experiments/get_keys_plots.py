...
if dir == "repo":
    key_class_counts = key_class_counts_repo
    key_task_counts = key_task_counts_repo
elif dir == "batchwise":
    key_class_counts = key_class_counts_batchwise
    key_task_counts = key_task_counts_batchwise
elif dir == "no_batchwise":
    key_class_counts = key_class_counts_no_batchwise
    key_task_counts = key_task_counts_no_batchwise
...
with tqdm(total=2*num_keys+num_tasks+num_classes) as pbar:
    for i in range(num_keys):
        ...
        plt.savefig(f'../../plots/{dir}/key_class_counts/key_class_counts_key_{i}.png')
        plt.clf()
        pbar.update(1)
    ...
    for i in range(num_keys):
        ...
        plt.savefig(f'../../plots/{dir}/key_task_counts/key_task_counts_key_{i}.png')
        plt.clf()
        pbar.update(1)
    ...
    for i in range(num_tasks):
        ...
        plt.savefig(f'../../plots/{dir}/task_key_counts/task_key_counts_task_{i}.png')
        plt.clf()
        pbar.update(1)
    ...
    for i in range(num_classes):
        ...
        plt.savefig(f'../../plots/{dir}/class_key_counts/class_key_counts_class_{i}.png')
        plt.clf()
        pbar.update(1)
...
plt.xlabel("Tasks")
plt.ylabel("Keys")
plt.savefig(f'../../plots/{dir}/heatmaps/key_task_heatmap.png')
plt.clf()
# plt.show()
...
plt.xlabel("Classes")
plt.ylabel("Keys")
plt.savefig(f'../../plots/{dir}/heatmaps/key_class_heatmap.png')
plt.clf()
# plt.show()
