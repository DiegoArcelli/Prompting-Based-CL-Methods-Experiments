...
def get_args_parser(subparsers):
    ...
    subparsers.add_argument('--pool_size', default=5, type=int,)
    ...
    subparsers.add_argument('--use_prompt_mask', default=True, type=boolean_string)
    subparsers.add_argument('--train_mask', default=True, type=boolean_string)
